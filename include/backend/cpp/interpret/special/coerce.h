...
#ifndef __TW_MAPLE_BACKEDN_CPP_INTERPRET_COERCE_H__
#define __TW_MAPLE_BACKEDN_CPP_INTERPRET_COERCE_H__
...
struct Coerce : public Interpreter
{   
	...
	{
		AST::CoercePtr COERCE = STATIC_CAST( AST::Coerce, node);
