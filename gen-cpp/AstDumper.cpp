...
uint32_t AstDumper_startFunctionAttribute_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t AstDumper_startFunctionAttribute_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("AstDumper_startFunctionAttribute_args");
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
  return xfer;
}

uint32_t AstDumper_startFunctionAttribute_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("AstDumper_startFunctionAttribute_pargs");
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
  return xfer;
}

uint32_t AstDumper_endFunctionAttribute_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t AstDumper_endFunctionAttribute_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("AstDumper_endFunctionAttribute_args");
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
  return xfer;
}

uint32_t AstDumper_endFunctionAttribute_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("AstDumper_endFunctionAttribute_pargs");
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
  return xfer;
}
...
uint32_t AstDumper_startClassName_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t AstDumper_startClassName_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("AstDumper_startClassName_args");
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
  return xfer;
}

uint32_t AstDumper_startClassName_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("AstDumper_startClassName_pargs");
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
  return xfer;
}

uint32_t AstDumper_endClassName_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t AstDumper_endClassName_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("AstDumper_endClassName_args");
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
  return xfer;
}

uint32_t AstDumper_endClassName_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("AstDumper_endClassName_pargs");
  xfer += oprot->writeFieldStop();
  xfer += oprot->writeStructEnd();
  return xfer;
}
...
void AstDumperClient::startFunctionAttribute()
{
  send_startFunctionAttribute();
}

void AstDumperClient::send_startFunctionAttribute()
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("startFunctionAttribute", ::apache::thrift::protocol::T_CALL, cseqid);

  AstDumper_startFunctionAttribute_pargs args;
  args.write(oprot_);
...
void AstDumperClient::endFunctionAttribute()
{
  send_endFunctionAttribute();
}

void AstDumperClient::send_endFunctionAttribute()
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("endFunctionAttribute", ::apache::thrift::protocol::T_CALL, cseqid);

  AstDumper_endFunctionAttribute_pargs args;
  args.write(oprot_);
...
void AstDumperClient::startClassName()
{
  send_startClassName();
}

void AstDumperClient::send_startClassName()
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("startClassName", ::apache::thrift::protocol::T_CALL, cseqid);

  AstDumper_startClassName_pargs args;
  args.write(oprot_);
...
void AstDumperClient::endClassName()
{
  send_endClassName();
}

void AstDumperClient::send_endClassName()
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("endClassName", ::apache::thrift::protocol::T_CALL, cseqid);

  AstDumper_endClassName_pargs args;
  args.write(oprot_);
...
void AstDumperProcessor::process_startFunctionAttribute(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("AstDumper.startFunctionAttribute", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "AstDumper.startFunctionAttribute");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "AstDumper.startFunctionAttribute");
  }

  AstDumper_startFunctionAttribute_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "AstDumper.startFunctionAttribute", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "AstDumper.startFunctionAttribute");
    }
    return;
  }

  if (eventHandler_.get() != NULL) {
    eventHandler_->asyncComplete(ctx, "AstDumper.startFunctionAttribute");
  }

  return;
}

void AstDumperProcessor::process_endFunctionAttribute(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("AstDumper.endFunctionAttribute", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "AstDumper.endFunctionAttribute");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "AstDumper.endFunctionAttribute");
  }

  AstDumper_endFunctionAttribute_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "AstDumper.endFunctionAttribute", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "AstDumper.endFunctionAttribute");
    }
    return;
  }

  if (eventHandler_.get() != NULL) {
    eventHandler_->asyncComplete(ctx, "AstDumper.endFunctionAttribute");
  }
...
void AstDumperProcessor::process_startClassName(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("AstDumper.startClassName", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "AstDumper.startClassName");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "AstDumper.startClassName");
  }

  AstDumper_startClassName_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "AstDumper.startClassName", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "AstDumper.startClassName");
    }
    return;
  }

  if (eventHandler_.get() != NULL) {
    eventHandler_->asyncComplete(ctx, "AstDumper.startClassName");
  }

  return;
}

void AstDumperProcessor::process_endClassName(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("AstDumper.endClassName", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "AstDumper.endClassName");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "AstDumper.endClassName");
  }

  AstDumper_endClassName_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "AstDumper.endClassName", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "AstDumper.endClassName");
    }
    return;
  }

  if (eventHandler_.get() != NULL) {
    eventHandler_->asyncComplete(ctx, "AstDumper.endClassName");
  }
